...
## 1. Word Cloud
1.  **Create & Run**: Activity -> **Word Cloud** -> Click **Present**.
...
## 2. Clickable Image
1.  **Create & Run**: Activity -> **Clickable Image** -> Click **Present**.
